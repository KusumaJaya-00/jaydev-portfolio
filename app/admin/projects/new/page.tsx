  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="notch bg-card border border-border max-w-2xl space-y-5 p-6 md:p-8">
        ...
        <ImageUpload name="featured_image" label="Featured Image" folder="projects" />
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2"><Switch id="is_featured" name="is_featured" defaultChecked={false} /><Label htmlFor="is_featured">Featured</Label></div>
