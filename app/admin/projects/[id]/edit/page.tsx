  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="notch bg-card border border-border max-w-2xl space-y-5 p-6 md:p-8">
        ...
        <MarkdownEditor defaultValue={project.content || ''} />
        ...
        <ImageUpload name="featured_image" label="Featured Image" folder="projects" defaultValue={project.featured_image || ''} />
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2"><Switch id="is_featured" name="is_featured" defaultChecked={project.is_featured} /><Label htmlFor="is_featured">Featured</Label></div>
